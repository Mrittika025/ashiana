...
<body>
    <div class="wrap">
        ...
        <div class="page-header">
            <!-- LEFTSIDE header -->
            <div class="leftside-header" style="color: #54151b">
                <div class="logo">
        ...
        <div class="page-body">
            ...
            <div class="left-sidebar">
                ...
                <div class="left-sidebar-header">
                    <div class="left-sidebar-title" style="color: orange; font-size: 12px;">Ashiana Admin Panal</div>
                ...
                <!-- NAVIGATION -->
                <!-- ========================================================= -->
                <div id="left-nav" class="nano" style="background: #721c24">
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                <!--HOME-->
                                <li style="background: #721c24;" class="{{ request()->is('dashboard') ? 'active-item' : '' }}"><a
